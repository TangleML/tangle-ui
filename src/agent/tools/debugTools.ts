/**
 * Execution debugging tools — browser fetch against the Tangle backend.
 * Mirrors `scripts/agent/mcp/executionDebugTools.ts`. All tools are
 * read-only.
 */
