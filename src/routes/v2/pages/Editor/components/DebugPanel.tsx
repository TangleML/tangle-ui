  ...
  return (
    <Tabs defaultValue="stats" className="h-full flex flex-col">
            ...
            <DialogContent className="max-w-2xl">
              ...
              {systemClipboard.kind === "envelope" && (
                <BlockStack gap="3">
                  ...
                  <div className="flex flex-col h-[60vh] rounded-md overflow-hidden w-full bg-muted border border-border">
              ...
              {systemClipboard.kind === "text" && (
                <pre className="max-h-96 overflow-auto rounded-md bg-muted border border-border p-3 text-xs font-mono text-foreground whitespace-pre-wrap break-all">
      ...
      <TabsContent value="yaml" className="flex-1 min-h-0">
        <div className="m-2 h-full min-h-75 rounded-md overflow-hidden bg-muted border border-border relative">
          <div className="absolute inset-0">
