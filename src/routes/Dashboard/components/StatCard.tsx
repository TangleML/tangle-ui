...
export const PURPLE_SURFACE_BG = "bg-violet-500/6";
export const PURPLE_SURFACE_BG_HOVER = "hover:bg-violet-500/10";
export const PURPLE_BORDER = "border-violet-500/25";
...
export const StatCard = ({
  ...
  <button
    ...
    disabled={!onClick}
    className={cn(
      "rounded-xl border bg-transparent px-4 py-3 text-left transition-colors",
      PURPLE_BORDER,
      onClick
        ? cn(
