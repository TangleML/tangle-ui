...
const FlowCanvas = ({
  ...
  const onConnect = useCallback(
    (connection: Connection) => {
      ...
      if (isAggregatorConnection && result.shouldCreateEdge && result.redirectedConnection) {
        ...
        requestAnimationFrame(() => {
          ...
          const finalGraphSpec = handleConnection(latestGraphSpecRef.current, redirectedConn);
