      ...
      <ImportComponent
        triggerComponent={
          <InlineStack
            ...
            blockAlign="center"
            align="center"
            className="w-full py-1.5 cursor-pointer hover:text-gray-900 transition-colors border border-dashed border-border rounded-lg hover:border-gray-400 text-muted-foreground dark:hover:text-foreground dark:hover:border-muted-foreground"
