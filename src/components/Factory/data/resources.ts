...
export const RESOURCES = {
  ...
  ironore: {
    name: "Iron Ore",
    description: "Raw iron ore that must be smelted before use.",
    color: RESOURCE_COLORS.ironore,
    value: RESOURCE_VALUES.ironore,
    icon: "🪨",
  },
  iron: {
    name: "Iron",
  ...
  gold: {
    ...
    value: RESOURCE_VALUES.gold,
    icon: "🥇",
  },
  wool: {
    name: "Wool",
    description: "Soft fibers from sheep, used in textile production.",
    color: RESOURCE_COLORS.wool,
    value: RESOURCE_VALUES.wool,
    icon: "🐑",
  },
  jewelry: {
    name: "Jewelry",
    description: "Precious ornaments crafted from metals.",
    color: RESOURCE_COLORS.jewelry,
    value: RESOURCE_VALUES.jewelry,
    icon: "💎",
  },
  furniture: {
    name: "Furniture",
    description: "Finely crafted wooden furniture.",
    color: RESOURCE_COLORS.furniture,
    value: RESOURCE_VALUES.furniture,
    icon: "🪑",
  },
  clothing: {
    name: "Clothing",
    description: "Basic garments made from wool.",
    color: RESOURCE_COLORS.clothing,
    value: RESOURCE_VALUES.clothing,
    icon: "👕",
  },
  fineclothing: {
    name: "Fine Clothing",
    description: "Luxurious garments made from wool and leather.",
    color: RESOURCE_COLORS.fineclothing,
    value: RESOURCE_VALUES.fineclothing,
    icon: "👗",
  },
  artwork: {
    name: "Artwork",
    description: "Beautiful creations that inspire and enrich culture.",
    color: RESOURCE_COLORS.artwork,
    value: RESOURCE_VALUES.artwork,
    icon: "🎨",
  },
...
type FoodProducingResourceType = {
