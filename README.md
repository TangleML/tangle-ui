...
To enable error reporting, add the following variable to your `.env` file:

```bash
VITE_BUGSNAG_API_KEY=your-api-key
```

Errors are automatically captured from React components, router navigation, and network requests.
